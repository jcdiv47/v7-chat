...
**Caveat.** This is a canned demo response — set \`OPENROUTER_API_KEY\` in the Convex deployment (and \`INTERMEDIATE_DATABASE_URL\`) to get real, model-generated answers over live data.
